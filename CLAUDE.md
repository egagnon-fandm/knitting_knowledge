...
This wiki is a structured, interlinked knowledge base for academic research about knitted, woven, and crafted materials.
...
tutorials/    -- tutorials about specific topics maintained by Claude
```
...
When the user asks you to update tutorials:
...
Each tutorial should have the following format:
